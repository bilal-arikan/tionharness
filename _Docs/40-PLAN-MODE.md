...
> Durum: **Tamamlandı (2026-06-28).** claude-cli'nin yerleşik plan modunu TionSwarm'nun
...
TionSwarm'nun Interaction MCP `permission_prompt` handler'ına düşer. Orada özel ele
