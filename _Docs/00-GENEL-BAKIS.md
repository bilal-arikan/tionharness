...
| [77-ROTA-ALTYAPI-PLANI.md](77-ROTA-ALTYAPI-PLANI.md) | **TASLAK (2026-09-02); R1, R4, R3, R2, R5, R6 uygulandı** — Rota (oturumları dinamik/çatallanan akış grafiğine hizalama + workspace canlı görünümü + koşu-sonu optimizer) öncesi altyapı hazırlığı: 10 refactor kalemi (oturum kökeni `SessionOrigin`, canlılık kaydı, workspace olay günlüğü, sidecar soyutlaması, otomasyon tetik registry + arşiv, reçete şeması, koordinasyon gözlemcisi, flow bağlantı düzeltmeleri, view/graph, frontend), üç dalga, kapı ölçütleri |
