...
| [83-EVRIM-MEKANIZMASI.md](83-EVRIM-MEKANIZMASI.md) | **Araştırma + tasarım (2026-09-04, uygulanmadı)** — Hedef (Goal) güdümlü workspace evrimi: mevcut yapı taşları (recipe-optimizer, insight, curator, ajan kalıtımı), akademik ve pratisyen literatür taraması (Goodhart, overfitting, model-sürümü regresyonu, bağlam çöküşü), Goal/Snapshot/Proposal/Ledger tasarımı ve E0–E5 faz planı |
