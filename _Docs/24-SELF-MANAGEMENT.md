...
> Kaynaklar: `internal/tools/builtin_{agentmgmt,flowmgmt,schedulemgmt,taskmgmt,hookmgmt,mcpmgmt,workspacemgmt,artifactmgmt,memory_add,logs,secret,skillmgmt,settings}.go`,
