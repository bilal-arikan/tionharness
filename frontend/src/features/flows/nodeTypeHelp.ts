...
export const NODE_TYPE_HELP: Record<FlowNodeType, string> = {
  ...
  end: 'Opsiyonel bitiş düğümü. Akışı sonlandırır; istenirse bir şablonla nihai çıktıyı biçimlendirir veya bir JSON şemasıyla doğrular. Yoksa akış son düğümün çıktısıyla biter.',
  agent:
  ...
  loop: 'İçindeki gövde zincirini, maksimum tekrar sayısına ulaşana ya da bitiş koşulu sağlanana kadar tekrarlar. Gövde içinde {{iteration}} değişkeni geçerli tur numarasını verir.',
  'await-input':
  ...
  join: 'Bariyer düğümü: bir Spawn düğümünün başlattığı alt-koşuların bitmesini bekler, çıktılarını toplar ve tek sonuç olarak devam eder.',
  coordinator:
