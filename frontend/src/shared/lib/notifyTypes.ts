...
export const NOTIFY_TYPES: NotifyType[] = [
  { type: 'chat', label: 'Sohbet yanıtı', hint: 'Asistan yanıtı tamamlandı (yanıt-hazır bildirimi + sesi).', view: 'chat', cue: 'done' },
  { type: 'prompt', label: 'Onay / soru', hint: 'Ajan bir onay, izin ya da soru ile senden yanıt bekliyor.', view: 'chat', cue: 'ask' },
  { type: 'schedule', label: 'Zamanlamalar', hint: 'Zamanlanmış prompt çalıştı / başarısız oldu.', view: 'schedules', cue: null },
  { type: 'flow', label: 'Akışlar', hint: 'Akış (flow) çalışması tamamlandı / başarısız oldu.', view: 'flows', cue: null },
  { type: 'spawned', label: 'Spawn', hint: 'Alt-oturum (spawn) çalışması tamamlandı / başarısız oldu.', view: 'chat', cue: null },
  { type: 'worker', label: 'Worker', hint: 'Koordinatör worker durumu değişti.', view: 'chat', cue: null },
  { type: 'coordination', label: 'Koordinasyon', hint: 'Koordinatör tur limiti gibi koordinasyon uyarıları.', view: null, cue: null },
  { type: 'automation', label: 'Otomasyonlar', hint: 'Etiket/pano otomasyonu tetiklendi.', view: null, cue: null },
  { type: 'artifact', label: 'Artifacts', hint: 'Artifact oluşturuldu / güncellendi.', view: 'artifacts', cue: null },
  { type: 'board', label: 'Görevler (pano)', hint: 'Kanban görevi oluşturuldu / taşındı / güncellendi / silindi.', view: 'board', cue: null },
  { type: 'agent', label: 'Ajan bildirimi', hint: 'Ajanın notify aracıyla gönderdiği genel bildirim.', view: null, cue: null },
  { type: 'anomaly', label: 'Anomaliler', hint: 'Oturum uyarısı: düşük cache-isabet, sık kırılım, araç hatası vb.', view: null, cue: null },
]
