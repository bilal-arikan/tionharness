...
export function SplashScreen() {
  return (
    <div
      ...
      style={{ animation: 'swarmgo-splash-fade 280ms ease-out' }}
    >
      ...
      <div className="relative flex h-24 w-24 items-center justify-center">
        ...
        <img
          ...
          alt="SwarmGo"
          className="h-12 w-12"
          style={{ animation: 'swarmgo-splash-pulse 1600ms ease-in-out infinite' }}
        />
      </div>

      <div className="flex flex-col items-center gap-1">
        <span className="text-lg font-semibold tracking-wide">SwarmGo</span>
      ...
      <style>{`
        @keyframes swarmgo-splash-fade {
          from { opacity: 0; }
          to { opacity: 1; }
        }
        @keyframes swarmgo-splash-pulse {
