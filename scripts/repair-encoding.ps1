# SwarmGo — UTF-8-as-CP1254 mojibake onarim araci (one-shot).
#
# KOK NEDEN: SwarmGo'nun depolama/Go I/O yolu UTF-8 temizdir. Bozulma, govdeyi
...
#   .\scripts\repair-encoding.ps1 -StoreRoot 'C:\Users\user\.swarmgo\workspaces'
...
param(
    [string]$StoreRoot = "$env:USERPROFILE\.swarmgo\workspaces",
