...
// ConfigValidateTool validates a TionHarness JSON config file: that it is well-formed
...
func (ConfigValidateTool) Def() providers.ToolDef {
	return providers.ToolDef{
		...
		Description: "Validate a TionHarness JSON config file (well-formed JSON + expected fields for known " +
