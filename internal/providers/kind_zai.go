...
func init() {
	RegisterKind(NewBuiltinKind(
		Manifest{
			...
			Order:            5,
			Models: []ModelInfo{
				{ID: "glm-5.2", Label: "GLM-5.2 — güncel amiral", Description: "Anthropic modu: araç kullanımı + düşünme"},
				{ID: "glm-5.1", Label: "GLM-5.1 — önceki nesil", Description: "Anthropic modu: araç kullanımı + düşünme"},
				{ID: "glm-5-turbo", Label: "GLM-5 Turbo — hızlı/ucuz", Description: "Düşük gecikme, yüksek hacim"},
				{ID: "glm-4.7", Label: "GLM-4.7 — önceki kodlama modeli", Description: "Anthropic modu: araç kullanımı"},
			},
		},
