...
type openrouterKind struct{}

func (openrouterKind) Manifest() Manifest {
	return Manifest{
		Kind:             "openrouter",
...
func (openrouterKind) Available(cfg ResolvedConfig) bool { return cfg.Key != "" }

func (openrouterKind) Build(cfg ResolvedConfig) (Provider, error) {
	if cfg.Key == "" {
...
func init() { RegisterKind(openrouterKind{}) }
