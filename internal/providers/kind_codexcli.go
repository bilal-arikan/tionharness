...
func init() {
	RegisterKind(NewBuiltinKind(
		Manifest{
			...
			// TionHarness tools called over the MCP bridge run PreToolUse/PostToolUse
			...
			Models: []ModelInfo{
				...
				{ID: "gpt-6-astra", Label: "GPT-6 Astra — öncü", Description: "En yetenekli nesil; 1.05M bağlam (922k girdi), 128k çıktı, max'a kadar akıl yürütme. 272k üzeri istekler tüm istek için 2× girdi/cache ve 1.5× çıktı ücretlendirilir. API faturalı: ChatGPT aboneliğinde kademeli açılır, Enterprise'da yönetici onayı ister"},
