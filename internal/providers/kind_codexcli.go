	...
	RegisterKind(NewBuiltinKind(
		Manifest{
			...
			Models: []ModelInfo{
				...
				{ID: "gpt-5.6-terra", Label: "GPT-5.6 Terra", Description: "En yeni nesil; 272k bağlam"},
				{ID: "gpt-5.6-luna", Label: "GPT-5.6 Luna", Description: "En yeni nesil; 272k bağlam"},
				{ID: "gpt-5.5", Label: "GPT-5.5 — varsayılan", Description: "codex-cli varsayılanı; 272k bağlam"},
