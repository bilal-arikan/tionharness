...
// (reusing the same Motor-B pricing helpers as the workspace Budget screen) and
// the prompt-cache USD savings. This is the data behind the per-session budget
// card in the session detail panel — the session-scoped analog of /api/usage.
