...
triggers, `tionswarm-autonomous-ops` §4) and **Hooks** (tool-call interception) —
...
> The tools live in `tionswarm-self-management`; targets come from `list_agents` /
> `list_flows`.
